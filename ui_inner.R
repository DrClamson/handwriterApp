    ...
    fluidPage(
      ...
      conditionalPanel(condition="input.prevreport == 'Known Writing'",
                       div(id = "autonomous",
                           ...
                           fluidRow(column(5, numericInput("known_writer_start_char", label="Start location", value=1, min=1, max=100)),
                                    column(5, numericInput("known_writer_end_char", label="End location", value=1, min=1, max=100))),
                           helpText(id="known_docID_help", "Where are the document numbers located in the file names?"),
                           fluidRow(column(5, numericInput("known_doc_start_char", label="Start location", value=1, min=1, max=100)),
                                    column(5, numericInput("known_doc_end_char", label="End location", value=1, min=1, max=100))),
      ...
      conditionalPanel(condition="input.prevreport == 'Questioned Document'",
                       div(id = "autonomous",
                           ...
                           fluidRow(column(5, numericInput("qd_writer_start_char", label="Start location", value=1, min=1, max=100)),
                                    column(5, numericInput("qd_writer_end_char", label="End location", value=1, min=1, max=100))),
                           helpText(id="qd_docID_help", "Where are the document numbers located in the file names?"),
                           fluidRow(column(5, numericInput("qd_doc_start_char", label="Start location", value=1, min=1, max=100)),
                                    column(5, numericInput("qd_doc_end_char", label="End location", value=1, min=1, max=100))),
