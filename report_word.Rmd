...
```{r qd, echo=FALSE, fig.cap="Figure 1. The questioned document scaled to the width of the page.", fig.align="center", out.width= "100%"}
...
```{r qdgraphs, echo=FALSE, fig.cap="Figure 2. The questioned document split into graphs.", out.width= "100%"}
...
```{r qdprofile, echo=FALSE, fig.cap="Figure 3. The writer profile from the questioned document", fig.align="center", message=FALSE, fig.show='hold'}
...
knitr::kable(
  ...
  caption = 'Table 1. Known writing samples from persons of interest.'
)
```
...
```{r knownprofiles, echo=FALSE, fig.cap="Figure 4. Estimates of the writer profiles of the persons of interest. The error bars show the 2.5% and 9.75% credible intervals.", fig.align="center"}
...
knitr::kable(
  pp, booktabs = TRUE,
  caption = 'Table 2. The posterior probability that each person of interest wrote the questioned document.'
)
```
