...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/handwriterApp)](https://CRAN.R-project.org/package=handwriterApp)
<!-- badges: end -->
...
- Install RStudio IDE from [https://posit.co/downloads/]. Click Download RStudio.
- Install JAGS from [https://sourceforge.net/projects/mcmc-jags/files/]. Click Download 
...
handwriterApp()
```
In the pop-up window, click Open in Browser. If you use the app in the pop-up window instead of in a browser, some of the links will not work.

Follow the instructions in the app to view a demo or simulate casework with real handwriting samples.
