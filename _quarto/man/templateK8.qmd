...
## Cluster Template with Eight Clusters {.unnumbered}
...
<pre><code class='language-R'>templateK8
</code></pre>
...
<code>handwriter::make_clustering_template</code>. The cluster template was created by sorting
...
<dl>
<dt>centers_seed</dt><dd>An integer for the random number generator.
</dd>
...
<dt>K</dt><dd>The number of clusters to build (10) with the K-means algorithm.
</dd>
<dt>n</dt><dd>The number of training graphs to use (1000) in the K-means
algorithm.
</dd>
